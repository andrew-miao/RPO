...
def add_args(parser):
    parser.add_argument(
        ...
        type=str,
        default="duongna/stable-diffusion-v1-4-flax",
        required=True,
    ...
    parser.add_argument(
        ...
        type=str,
        default="mix",
        help="The validation reward model type.",
    )
    parser.add_argument(
        "--reward_lambda",
        type=float,
...
def dreambooth_args(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        default="A photo of sks dog",
        help="The prompt with identifier specifying the class",
    )
    parser.add_argument(
        "--class_token",
        type=str,
    ...
    parser.add_argument("--beta", type=float, default=1.0, help="The weight of KL divergence in DPO.")
    parser.add_argument(
        "--savepath",
        type=str,
        default="models/dreambooth",
        help="The output directory where the model predictions and checkpoints will be written.",
    )
    parser.add_argument(
        "--savesamples",
        type=str,
        default="samples/dreambooth",
        help="The output directory where the samples will be saved.",
    )
    parser.add_argument(
        "--subject",
    ...
    parser.add_argument(
        ...
        type=str,
        default="mix",
        help="The validation reward type",
    )
    parser.add_argument(
        "--reward_lambda",
        type=float,
...
def generate_data_parser(parser):
    parser.add_argument(
        "--pretrained_model_name_or_path",
        type=str,
        default="duongna/stable-diffusion-v1-4-flax",
...
def dreambooth_lora_args(parser, input_args=None):
    parser.add_argument(
        "--pretrained_model_name_or_path",
        type=str,
        default=None,
    ...
    parser.add_argument(
        "--bucket",
        type=str,
        default="dreambooth-lora",
        help="Google Cloud Bucket to store the data.",
    )
    parser.add_argument(
        "--reward_lambda",
        type=float,
